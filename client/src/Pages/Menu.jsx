        ...
        <CardContent>
          ...
          >
            ...
            <p
              ...
              style={{ opacity: "1", backgroundColor: "#f8bd79" }}
            >
              <IoStarSharp className="star-icons" />
              4.5
            </p>
          </div>
        </CardContent>
...
const MenuSpecial = ({ specialMenu }) => {
  ...
  return (
    <>
      <h1 className="special-h1">Today's Special</h1>
    ...
    <>
      ...
      >
        ...
        <div className="view-menu">
          <p className="">
            You can view our menu <Link to="#">here</Link>. You will be
            redirected to a new page where you can explore all our offerings.
            Once you've made your selection, please use the form below to place
            your order.
          </p>
          <div>
